...
#[async_trait]
pub trait ForgeApi {
    /// Get the forge loader versions compatible with the specified game version
    async fn get_forge_v2_versions_loader_game_version(&self, arch: String, game_version: String, installation_id: String, launcher_version: String, os: String, os_release: String, hwid: Option<String>, hwid_private: Option<String>) -> ApiResult<Vec<String>>;
}

#[async_trait]
impl ForgeApi for RawApiClient {
    async fn get_forge_v2_versions_loader_game_version(&self, arch: String, game_version: String, installation_id: String, launcher_version: String, os: String, os_release: String, hwid: Option<String>, hwid_private: Option<String>) -> ApiResult<Vec<String>> {
        let url = self.build_url(&format!("/forge/v2/versions/loader/{}", &game_version.to_string()));
