...
use super::launcher_vanilla_subversion::LauncherVanillaSubversion;
use super::launcher_vanilla_version_images::LauncherVanillaVersionImages;
use super::launcher_version_carousel_image::LauncherVersionCarouselImage;

#[derive(Serialize, Deserialize, Default, Clone, Debug, PartialEq)]
pub struct LauncherVanillaVersion {
    ...
    pub images: LauncherVanillaVersionImages,
    ...
    pub subversions: Vec<LauncherVanillaSubversion>,
}