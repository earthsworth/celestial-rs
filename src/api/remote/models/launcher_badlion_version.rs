...
use super::launcher_badlion_subversion::LauncherBadlionSubversion;
use super::launcher_badlion_version_images::LauncherBadlionVersionImages;
use super::launcher_version_carousel_image::LauncherVersionCarouselImage;

#[derive(Serialize, Deserialize, Default, Clone, Debug, PartialEq)]
pub struct LauncherBadlionVersion {
    ...
    pub images: LauncherBadlionVersionImages,
    ...
    pub subversions: Vec<LauncherBadlionSubversion>,
}